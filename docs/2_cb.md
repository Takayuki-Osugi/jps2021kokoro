...
### 変化の見落とし
注意が情報の認識や記憶のために重要であることは，”変化の見落とし現象”によって示されています(Rensink, O’Regan, & Clark, 1997)。例えば，以下のように一部分だけが異なる２枚の画像を用意します。この画像を画面に0.2秒ごとに繰り返し呈示します（フリッカー法）。
...
<img src='./image/procedure.jpeg' width='80%'>
